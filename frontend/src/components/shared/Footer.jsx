      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job Orbit</h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved. <span className='text-[#F83002]'>Himanshu sharma</span></p>
          </div>
